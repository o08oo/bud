...
class Main extends Sprite 
{
	...
	var framerate:Int = 59; // How many frames per second the game should run at.
	...
	private function setupGame():Void
	{
		...
		//addChild(new FlxGame(320, 240, initialState, 3, framerate, framerate, skipSplash, startFullscreen));
		addChild(new FlxGame(90,160, initialState, 2, framerate, framerate, skipSplash, startFullscreen));
